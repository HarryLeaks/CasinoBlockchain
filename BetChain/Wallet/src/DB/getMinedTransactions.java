...
public class getMinedTransactions {
private static final String getTable = "SELECT SenderPublicAddress, ReceiverPublicAddress, Amount, TimeStamp FROM transactions WHERE MinedTransaction = '1'";
